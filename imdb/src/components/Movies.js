...
function Movies() {
    ...
    useEffect(function () {
        ...
        // everytime when page reloads data will be saved for added favourites
        let oldFav = localStorage.getItem("imdb");
        oldFav = JSON.parse(oldFav) || [];
        console.log(oldFav);

        // data retrive from api 
    ...
    let add = (movie) => {
        ...
        // after clicking favourites will be stored in a local storage as an array for reload 
    ...
    let del = (movie) => {
        ...
        setFavourites([...newArray])
        // for deleting data from the favourites
        localStorage.setItem("imdb", JSON.stringify(newArray))
    }
